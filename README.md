...
```
# Primero y asegurate de tener el ip forwarding activado, para esto dentro del siguiente archivo debe haber un 1:
# /proc/sys/net/ipv4/ip_forward
# Luego simplemente ejecuta el script presente en este repo de la forma ./Man-in-The-Mirror.sh [INTERFAZ] [PUERTOS]
